...
elif "password reset" in subject.lower() or "free" in subject.lower():
...
It felt natural to use the keyword 'in' in this program, especially
because I have experience with Python already.  I also used 'or' but I can't
remember if we saw it in the notes.  I hope that is ok.  I will change it if 
it looks like the grading system doesn't like that I used 'or' yet.
